		...
		finishedLoading: function() {
			...
			if(this.options.controls)
			{
				var css = {
					...
					background: '#3bbcca',
					position: 'absolute',
					'box-shadow': '0 6px #31abbd',
					'z-index': 1200,
					'margin-top': '-25%',
					'visibility':'hidden'
				};
				
				this.nextButton = $('<a href="#"><div id="bnext">»</div></a>').css(css).css3({
				...
				this.prevButton = $('<a href="#"><div id="bprev">«</div></a>').css(css).css3({
			...
			{
				this.captionHead = $('<div class="captionhead">WE HELP YOU FULFILL YOUR DREAMS!</div>').css({
					color: '#FFF',
				...
				this.captionBar = $('<div class="captiontext"></div>').css({
